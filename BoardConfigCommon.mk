...
-include vendor/motorola/omap4-kexec-common/BoardConfigVendor.mk
...
ifdef BOARD_USE_TI_ENHANCED_DOMX
    ...
    TI_CUSTOM_DOMX_PATH := device/motorola/omap4-kexec-common/domx
    DOMX_PATH := device/motorola/omap4-kexec-common/domx
    ENHANCED_DOMX := true
else
